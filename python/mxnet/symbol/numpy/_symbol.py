...
__all__ = ['zeros', 'ones', 'add', 'subtract', 'multiply', 'divide', 'mod', 'power', 'sin', 'cos',
           ...
           'expm1', 'arcsin', 'arccos', 'arctan', 'sign', 'log', 'degrees', 'rad2deg', 'log2',
           'log1p', 'rint', 'radians', 'deg2rad', 'reciprocal', 'square', 'negative', 'fix',
           'ceil', 'floor', 'trunc', 'logical_not', 'arcsinh', 'arccosh', 'arctanh', 'tensordot',
